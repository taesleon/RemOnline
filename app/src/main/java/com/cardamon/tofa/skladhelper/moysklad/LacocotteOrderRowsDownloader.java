...
public class LacocotteOrderRowsDownloader extends Downloader {

    public LacocotteOrderRowsDownloader(AppCompatActivity activity, int showDialogMsg, int insertMsg) {
    super(activity, showDialogMsg, insertMsg);
    if (this.SHOW_DIALOG_MODE) {
        this.mRequestParams.clear();
        this.mRequestParams.setExtraParam("route=myscript/orderslctrows&");
    ...
    public LacocotteOrderRowsDownloader(AppCompatActivity appCompatActivity, int showDialogMsg, int insertMsg, FragmentOrder fragmentOrder) {
        this(appCompatActivity, showDialogMsg, insertMsg);
        mRequestParams.clear();
        mRequestParams.setExtraParam("route=myscript/orderslctrows&");
    ...
    protected void updateData() {
        mDbHelper.updateOrderRows(allRows, "LCT");
    }
}
