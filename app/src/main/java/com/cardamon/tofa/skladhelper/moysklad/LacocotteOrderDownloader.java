...
public class LacocotteOrderDownloader extends Downloader{
    public LacocotteOrderDownloader(AppCompatActivity activity, int showDialogMsg, int insertMsg) {
        super(activity, showDialogMsg, insertMsg);
        if (this.SHOW_DIALOG_MODE) {
            this.mRequestParams.clear();
            this.mRequestParams.setExtraParam("route=myscript/orderslct&");
    ...
    public LacocotteOrderDownloader(AppCompatActivity appCompatActivity, int showDialogMsg, int insertMsg, FragmentOrder fragmentOrder) {
        this(appCompatActivity, showDialogMsg, insertMsg);
        mRequestParams.clear();
        mRequestParams.setExtraParam("route=myscript/orderslct&");
    ...
    protected void updateData() {
        mDbHelper.updateOrders(allRows, "LCT");
    }
}
