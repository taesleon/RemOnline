...
public class StikkyHeaderListView extends StikkyHeader {
    ...
    StikkyHeaderListView(final Context context, final ListView listView, final View header, final int minHeightHeader, final HeaderAnimator headerAnimator, SwipeRefreshLayout sf) {
        super(context, header, minHeightHeader, headerAnimator);
        this.mListView = listView;
        this.mSwipeRefreshLayout = sf;
    }
